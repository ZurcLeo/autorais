...
export const CAIXINHA_EVENTS = {
  ...
  MEMBERS_FETCHED: 'caixinhas/MEMBERS_FETCHED'
};
...
export const LOAN_EVENTS = {
  LOANS_FETCHED: 'loans/LOANS_FETCHED',
  LOAN_DETAILS_FETCHED: 'loans/LOAN_DETAILS_FETCHED',
  LOAN_CREATED: 'loans/LOAN_CREATED',
  LOAN_UPDATED: 'loans/LOAN_UPDATED',
  LOAN_PAYMENT_MADE: 'loans/LOAN_PAYMENT_MADE',
  LOAN_APPROVED: 'loans/LOAN_APPROVED',
  LOAN_REJECTED: 'loans/LOAN_REJECTED',
  LOAN_COMPLETED: 'loans/LOAN_COMPLETED',
  FETCH_START: 'loans/FETCH_START',
  FETCH_FAILURE: 'loans/FETCH_FAILURE'
};

export const DISPUTE_EVENTS = {
  DISPUTES_FETCHED: 'disputes/DISPUTES_FETCHED',
  DISPUTE_DETAILS_FETCHED: 'disputes/DISPUTE_DETAILS_FETCHED',
  DISPUTE_CREATED: 'disputes/DISPUTE_CREATED',
  DISPUTE_VOTED: 'disputes/DISPUTE_VOTED',
  DISPUTE_RESOLVED: 'disputes/DISPUTE_RESOLVED',
  DISPUTE_CANCELED: 'disputes/DISPUTE_CANCELED',
  FETCH_START: 'disputes/FETCH_START',
  FETCH_FAILURE: 'disputes/FETCH_FAILURE'
};

// Adicionar ao arquivo core/constants/events.js
export const CAIXINHA_INVITE_EVENTS = {
  CAIXINHA_INVITES_FETCHED: 'caixinhaInvites/CAIXINHA_INVITES_FETCHED',
  CAIXINHA_INVITE_SENT: 'caixinhaInvites/CAIXINHA_INVITE_SENT',
  CAIXINHA_INVITE_ACCEPTED: 'caixinhaInvites/CAIXINHA_INVITE_ACCEPTED',
  CAIXINHA_INVITE_REJECTED: 'caixinhaInvites/CAIXINHA_INVITE_REJECTED',
  CAIXINHA_INVITE_CANCELED: 'caixinhaInvites/CAIXINHA_INVITE_CANCELED',
  CAIXINHA_INVITE_ERROR: 'caixinhaInvites/CAIXINHA_INVITE_ERROR',
...
export const BANKING_EVENTS = {
  ...
  PIX_GENERATED: 'banking/PIX_GENERATED',
  ...
  // Card payment events
  PAYMENT_START: 'banking/PAYMENT_START',
  PAYMENT_SUCCESS: 'banking/PAYMENT_SUCCESS',
  PAYMENT_FAILURE: 'banking/PAYMENT_FAILURE',
  CARD_TOKENIZED: 'banking/CARD_TOKENIZED',
  TOKENIZATION_FAILURE: 'banking/TOKENIZATION_FAILURE',
...
export const MESSAGE_EVENTS = {
  ...
  // Eventos de escalonamento para suporte humano
  ESCALATION_INITIATED: 'messages/ESCALATION_INITIATED',
  AI_SUGGESTS_ESCALATION: 'messages/AI_SUGGESTS_ESCALATION',
  ESCALATION_PENDING: 'messages/ESCALATION_PENDING',
  CONVERSATION_ASSIGNED: 'messages/CONVERSATION_ASSIGNED',
  ESCALATION_FAILED: 'messages/ESCALATION_FAILED'
};

/**
 * Eventos relacionados ao sistema de suporte.
 * @namespace SUPPORT_EVENTS
 * @enum {string}
 */
export const SUPPORT_EVENTS = {
  ...
  // Eventos de escalonamento (Legacy)
  ESCALATION_INITIATED: 'support/ESCALATION_INITIATED',
  ...
  // Eventos de atribuição de tickets (Agentes)
  TICKET_ASSIGNMENT_START: 'support/TICKET_ASSIGNMENT_START',
  TICKET_ASSIGNED_SUCCESS: 'support/TICKET_ASSIGNED_SUCCESS',
  TICKET_ASSIGNMENT_FAILED: 'support/TICKET_ASSIGNMENT_FAILED',
  
  // Eventos de resolução de tickets (Agentes)
  TICKET_RESOLUTION_START: 'support/TICKET_RESOLUTION_START',
  TICKET_RESOLVED_SUCCESS: 'support/TICKET_RESOLVED_SUCCESS',
  TICKET_RESOLUTION_FAILED: 'support/TICKET_RESOLUTION_FAILED',
  
  // Eventos de atualização de tickets
  TICKET_UPDATED: 'support/TICKET_UPDATED',
  NEW_TICKET_CREATED: 'support/NEW_TICKET_CREATED',
  
  // Eventos de conversa de tickets
  TICKET_CONVERSATION_LOADED: 'support/TICKET_CONVERSATION_LOADED',
  TICKET_NOTE_ADDED: 'support/TICKET_NOTE_ADDED',
  
  // Eventos de analytics
  ANALYTICS_LOADED: 'support/ANALYTICS_LOADED',
  
  // Eventos de erro
  SUPPORT_ERROR: 'support/SUPPORT_ERROR'
};