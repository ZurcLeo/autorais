...
// import { LOG_LEVELS } from './src/core/constants/config';

// console.log('Loading apiService.js...');
...
//     try {
//       coreLogger.logEvent('TokenManager', LOG_LEVELS.INITIALIZATION, 'Initializing token manager');
...
//         coreLogger.logEvent('TokenManager', LOG_LEVELS.INITIALIZATION, 'Loaded valid tokens from storage');
//       } else {
...
// window.tokenManager = TokenManager.getInstance();
// export const tokenManager = window.tokenManager;